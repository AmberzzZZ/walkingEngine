option(GoToShootPointKeeper, (Vector2f)(Vector2f(4500.f, 0.f)) refPoint, (Vector2f)(Vector2f(80.f, 80.f)) tolerate)//减少goaroundball状态的次数
{
...
//    			goto turnToBall;
    ...
    action
    {
      ...
      {
            WalkToTarget(Pose2f(0.3f, 0.7f, 0.3f), Pose2f(ball.angleRad, ball.x - 500, 0));
  ...
  state(walkToPointDirectly)
  {
	...
	action
	{
		...
		{
		    WalkToTarget(Pose2f(0.3f, 0.7f, 0.3f), Pose2f(ball.angleRad, ball.x - 180, 0));
		    //walkStraightToBall = true;
		}
		else
		{
