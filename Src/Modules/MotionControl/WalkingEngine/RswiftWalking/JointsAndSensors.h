...
struct SensorValues
{
                       ...
                       const JointAngles &joint)
  {
    ...
    sensors[Sensors::InertialSensor_AccX] = gyro.acc.x();
    sensors[Sensors::InertialSensor_AccY] = gyro.acc.y();
    sensors[Sensors::InertialSensor_AccZ] = gyro.acc.z();
    sensors[Sensors::InertialSensor_AngleX] = gyro.angle.x();
    sensors[Sensors::InertialSensor_AngleY] = gyro.angle.y();
